...
carritoSOUV.addEventListener('click', () => {sumarStorage()})
carritoAG.addEventListener('click', () => {sumarStorage()})
carritoCAL.addEventListener('click', () => {sumarStorage()})
carritoCUMP.addEventListener('click', () => {sumarStorage()})
